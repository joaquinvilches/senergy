...
SENERGY es una aplicación móvil diseñada para ayudar a usuarios en Chile a:

- Registrar y monitorear sus medidores eléctricos
...
### 3.1 Requisitos
Para utilizar SENERGY, debe:
- Tener al menos 18 años de edad o contar con autorización de un padre o tutor
...
- La exactitud de los datos que ingrese (lecturas, costos, tarifas)

## 4. Uso Aceptable

El Usuario se compromete a:
- Utilizar la Aplicación únicamente para fines legales y personales
- NO utilizar la Aplicación para actividades comerciales sin autorización
- NO intentar acceder a sistemas o datos no autorizados
- NO utilizar la Aplicación para dañar, interferir o sobrecargar nuestros servidores
- NO copiar, modificar o distribuir el contenido de la Aplicación sin autorización
...
### 5.3 Cambios de Precio
- Nos reservamos el derecho de modificar los precios con 30 días de aviso previo
- Si no acepta el nuevo precio, puede cancelar su suscripción antes de que entre en vigor
...
Le notificaremos cambios materiales a través de:
- Notificación in-app
...
❌ Usar SENERGY para actividades comerciales sin permiso
❌ Intentar hackear o dañar la aplicación
