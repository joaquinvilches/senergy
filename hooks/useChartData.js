 ...
 */
export const useChartData = (filteredReadings, selectedPeriod, selectedMeter, unit, colors, isDark) => {
  ...
  // Gráfico de torta (distribución por medidor) - AHORA CON isDark
  const pieData = useMemo(() => {
    return transformToPieChartData(filteredReadings, colors.TEXT_DARK, isDark);
  }, [filteredReadings, colors.TEXT_DARK, isDark]);
