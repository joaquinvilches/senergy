...
export const StatsScreen = () => {
  ...
  useChartData(filteredReadings, selectedPeriod, selectedMeter, unit, colors, isDark);
            ...
            {['kWh', '$'].map((u) => (
              ...
              >
                <Text
                  style={[
                    styles.unitText,
                    { color: unit === u ? '#FFFFFF' : colors.TEXT_LIGHT },
                  ]}
                >
                  {u === 'kWh' ? 'Consumo' : 'Costo'}
                </Text>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            <TouchableOpacity
              style={[
                ...
                selectedMeter === 'all' && { backgroundColor: colors.ACCENT },
              ]}
            ...
            {meters.map((meter) => (
              <TouchableOpacity
                ...
                style={[
                  styles.meterChip,
                  { borderColor: colors.BORDER },
                  selectedMeter === meter.id && { backgroundColor: colors.ACCENT },
                ]}
          ...
          >
            <View style={styles.pieChartWrapper}>
              <PieChart
                ...
                height={240}
                chartConfig={{
                  color: (opacity = 1) => hexToRgba(colors.TEXT_DARK, opacity),
                }}
                accessor="population"
